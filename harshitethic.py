...
if aienv == None:
    openai.api_key = "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"
else:
...
if tgenv == None:
    tgkey = "5916384877:AAGyrOI1_8Ebo7iOtdxHTXpXzHrR0ygn9aI"
else:
    tgkey = tgenv
print(tgenv)
...
def start(bot, update):
    ...
    if tim == 1:
        ...
        cache = None
        qcache = None
        botname = 'Ekampreet's Personal Assistant'
        username = 'Ekam_sAssitant_bot'
